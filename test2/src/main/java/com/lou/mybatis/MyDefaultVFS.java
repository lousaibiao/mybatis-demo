 ...
 * @author Ben Gunter
 */
public class MyDefaultVFS extends VFS {
    private static final Log log = LogFactory.getLog(MyDefaultVFS.class);
                ...
                try {
                    if (isJar(url)) {
                        ...
                        for (String line; (line = reader.readLine()) != null; ) {
                            if (log.isDebugEnabled()) {
                                System.out.println("当前编码："+Charset.defaultCharset());
    ...
    protected URL findJarForResource(URL url) throws MalformedURLException {
        ...
        try {
            ...
            if (isJar(testUrl)) {
                ...
                if (!file.exists()) {
                    try {
                        file = new File(URLEncoder.encode(jarUrl.toString(), "UTF8"));
